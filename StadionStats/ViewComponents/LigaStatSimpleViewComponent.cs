...
{
    public class LigaStatSimpleViewComponent : ViewComponent
    {
        private StatContext _context;

        public LigaStatSimpleViewComponent(StatContext context)
        {
            _context = context;
        }

        public async Task<IViewComponentResult> InvokeAsync(int ligastatID)
        {
